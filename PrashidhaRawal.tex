...
\begin{document}
    ...
    \section{Summary}
    \begin{onecolentry}
        Full Stack Developer with over 1 year of experience in building scalable web applications and web scraping solutions using React Native, Node.js, Express.js, MongoDB, and Next.js. Proficient in developing efficient REST APIs, integrating AI agents for real-time data processing, and implementing Go-based scraping pipelines. Skilled in MongoDB with geospatial queries, performance optimization, and cloud services (AWS, GCP). Adept at collaborating in Agile teams to deliver user-focused, maintainable code and API-driven platforms like Laterical.
    \end{onecolentry}

    \section{Technical Skills}
    \begin{onecolentry}
        \textbf{Programming Languages:} JavaScript, TypeScript, Python, Go
    \end{onecolentry}
